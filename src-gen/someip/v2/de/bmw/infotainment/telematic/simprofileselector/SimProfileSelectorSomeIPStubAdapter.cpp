 ...
 */
#include <v2/de/bmw/infotainment/telematic/simprofileselector/SimProfileSelectorSomeIPStubAdapter.hpp>
...
std::shared_ptr<CommonAPI::SomeIP::StubAdapter> createSimProfileSelectorSomeIPStubAdapter(
    ...
    return std::make_shared< SimProfileSelectorSomeIPStubAdapter<::v2::de::bmw::infotainment::telematic::simprofileselector::SimProfileSelectorStub>>(_address, _connection, _stub);
}
